...
/datum/species/human/halfelf
	...
	specstats = list("strength" = 0, "perception" = 1, "intelligence" = 0, "constitution" = 0, "endurance" = 0, "speed" = 2, "fortune" = -1)
	specstats_f = list("strength" = -1, "perception" = 1, "intelligence" = 1, "constitution" = 0, "endurance" = 0, "speed" = 2, "fortune" = -1)
