...
/datum/species/halforc
	...
	specstats = list("strength" = 2, "perception" = 0, "intelligence" = -1, "constitution" = 1, "endurance" = 1, "speed" = 0, "fortune" = -1)
	specstats_f = list("strength" = 2, "perception" = 0, "intelligence" = -1, "constitution" = 0, "endurance" = 2, "speed" = 0, "fortune" = -1)
