...
/datum/species/dwarf/mountain
	...
	specstats = list("strength" = 1, "perception" = 0, "intelligence" = -1, "constitution" = 2, "endurance" = 1, "speed" = -1, "fortune" = 0)
	specstats_f = list("strength" = 0, "perception" = 0, "intelligence" = 0, "constitution" = 2, "endurance" = 1, "speed" = -1, "fortune" = 0)
