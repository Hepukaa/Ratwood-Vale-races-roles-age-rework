...
/datum/species/aasimar
	...
	specstats = list("strength" = 0, "perception" = 1, "intelligence" = 0, "constitution" = -1, "endurance" = -1, "speed" = 1, "fortune" = 2)
	specstats_f = list("strength" = 0, "perception" = 1, "intelligence" = 0, "constitution" = -1, "endurance" = -1, "speed" = 1, "fortune" = 2)
